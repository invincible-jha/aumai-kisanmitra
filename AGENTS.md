# Agent Instructions for Kisanmitra

## Project Context
Kisanmitra is an open source Farmer mobile assistant with mandi prices and pest identification.

## Repository Layout
- `src/aumai_kisanmitra/` — package source
